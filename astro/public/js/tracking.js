...
(function () {
  ...
  // --- Form submit ---
  // form_submit is now emitted SERVER-SIDE from /api/lead (GA4 Measurement
  // Protocol) for every real lead, with full attribution. The real contact
  // form (baSendLead -> /api/lead) is not a Tilda form, so no client-side
