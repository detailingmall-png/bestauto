...
const SERVICE_KEYWORDS: Readonly<Record<string, readonly ServiceKeywordEntry[]>> = {
  ka: [
    ...
    },
    {
      ...
      keywords: ['გაბზარული შუშის შეკეთება', 'მანქანის შუშის აღდგენა', 'საქარე მინის შეკეთება', 'საქარე მინის აღდგენა', 'ნაკენჭრის შეკეთება', 'ნაკენძარის აღდგენა', 'ნაკენჭრის აღდგენა', 'ლაბავოის აღდგენა', 'ბზარის შეკეთება', 'ბზარის აღდგენა', 'მინის შეკეთება', 'შუშის აღდგენა'],
    },
    {
