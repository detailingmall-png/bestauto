  ...
  ka: [
    {
      ...
      keywords: ['დამცავი ფირის გადაკვრა', 'მანქანის დამცავი ფირი', 'პოლიურეთანის ფირი', 'PPF დამცავი ფირი', 'დამცავი ფირი', 'PPF ფირი'],
    },
    {
      service: 'vinyl-wrapping',
      url: '/vinyl-wrapping',
      keywords: ['მანქანაზე გადასაკრავი ფირი', 'ფირის გადაკვრა მანქანაზე', 'მანქანის გადასაკრავი', 'ფერის შეცვლა ფირით', 'ფირის გადაკვრა', 'ვინილის ფირი', 'ფირის დაკვრა'],
    },
    {
      service: 'auto-glass-tinting',
      url: '/auto-glass-tinting',
      keywords: ['შუშების დამუქება', 'მინების დამუქება', 'შუშების დაბურვა', 'მინების დაბურვა', 'დაბურული მინები'],
    },
    {
      service: 'polishing',
      url: '/polishing',
      keywords: ['საქარე მინის პოლირება', 'მანქანის პალიროვკა', 'მანქანის პოლირება', 'ფარების პოლირება', 'პალიროვკა', 'პოლირება'],
    },
    {
      service: 'ceramiccoating',
      url: '/ceramiccoating',
      keywords: ['კერამიკული პოლირება', 'კერამიკა მანქანაზე', 'კერამიკული საფარი', 'მანქანის კერამიკა', 'კერამიკა'],
    },
    {
      service: 'carwash',
      url: '/carwash',
      keywords: ['მანქანის სამრეცხაო', 'ავტომობილის რეცხვა', 'მანქანის გარეცხვა', 'მანქანის რეცხვა', 'ავტო სამრეცხაო', 'ავტოსამრეცხაო'],
    },
    {
      service: 'interior-cleaning',
      url: '/interior-cleaning',
      keywords: ['მანქანის სალონის წმენდა', 'ავტომობილის ქიმწმენდა', 'ხიმჩისტკა მანქანის', 'მანქანის ქიმწმენდა', 'სალონის ქიმწმენდა', 'ქიმწმენდა'],
    },
    {
      service: 'car-soundproofing',
      url: '/car-soundproofing',
      keywords: ['მანქანის ხმის იზოლაცია', 'ვიბრო იზოლაცია', 'ხმის იზოლაცია'],
    },
    {
      service: 'windshield-repair',
      url: '/windshield-repair',
      keywords: ['გაბზარული შუშის შეკეთება', 'მანქანის შუშის აღდგენა', 'საქარე მინის შეკეთება', 'საქარე მინის აღდგენა', 'ნაკენჭარის შეკეთება', 'ნაკენძარის აღდგენა', 'ნაკენჭარის აღდგენა', 'ლაბავოის აღდგენა', 'ბზარის შეკეთება', 'ბზარის აღდგენა', 'მინის შეკეთება', 'შუშის აღდგენა'],
    },
    {
