...
const KA_TRANSLATIONS: TranslationMap = [
  ['Выберите ближайшую студию<br>для <span class="gold">бесплатной консультации</span>', 'აირჩიეთ თქვენთან უახლოესი სტუდია<br><span class="gold">უფასო კონსულტაციისთვის</span>'],
  ['Выберите ближайшую студию<br>для <span class=\\"gold\\">бесплатной консультации</span>', 'აირჩიეთ თქვენთან უახლოესი სტუდია<br><span class=\\"gold\\">უფასო კონსულტაციისთვის</span>'],
