...
const KA_TRANSLATIONS: TranslationMap = [
  ['Выберите ближайшую студию<br>для <span class="gold">бесплатной консультации</span>', 'აირჩიეთ დეტეილინგ ცენტრი<br> <span class="gold">უფასო კონსულტაციისთვის</span>'],
  ['Выберите ближайшую студию<br>для <span class=\\"gold\\">бесплатной консультации</span>', 'აირჩიეთ დეტეილინგ ცენტრი<br> <span class=\\"gold\\">უფასო კონსულტაციისთვის</span>'],
  ...
  ['Оклейка защитной пленкой', 'დამცავი ფირით გადაკვრა'],
  ...
  ['Тонировка стекол', 'მინების დაბურვა'],
