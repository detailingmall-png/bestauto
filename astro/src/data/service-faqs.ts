  ...
  'interior-restoration': [
    ...
    },
    {
      ...
      answer: {
        ...
        ru: 'В 90% случаев — нет. Мы подбираем цвет и текстуру точно в соответствии с оригиналом. Покажем фото до/после аналогичных работ.',
        en: 'In 90% of cases — no. We match the color and texture precisely to the original. We\'ll show you before/after photos of similar work.',
      },
    },
    {
      question: {
    ...
    },
    {
      question: {
        ...
        ru: 'Какие типы повреждений вы восстанавливаете?',
      ...
      answer: {
        ...
        ru: 'Царапины, потёртости, прожоги от сигарет, разрывы, дыры, выцветший цвет, повреждённая кожа и пластик. Если повреждение слишком серьёзное — честно скажем и предложим альтернативу.',
    ...
    },
    {
      question: {
        ...
        ru: 'Можно ли перетянуть руль на свой вкус?',
        en: 'Can the steering wheel be rewrapped to my taste?',
      },
      answer: {
        ...
        ru: 'Да. Выбирайте цвет кожи, тип (наппа, перфорированная, экокожа), цвет и стиль строчки. Выполняем за 2–3 дня. Перед началом работы покажем образцы материалов.',
        en: 'Yes. Choose the leather color, type (nappa, perforated, eco-leather), stitching color and style. Completed in 2–3 days. We\'ll show you material samples before starting.',
      },
    },
    {
      question: {
        ka: 'რა მასალებს იყენებთ საჭისთვის?',
        ru: 'Какие материалы вы используете для руля?',
      ...
      answer: {
        ...
        ru: 'Натуральная кожа наппа, перфорированная кожа, премиальная экокожа. Все материалы прочные и приятные на ощупь. Подбираем под оригинал или по вашему желанию.',
        en: 'Natural nappa leather, perforated leather, premium eco-leather. All materials are durable and pleasant to the touch. We match to the original or customize to your preference.',
      },
    },
    {
      question: {
        ka: 'რა მასალებს იყენებთ სავარძლებისთვის?',
        ru: 'Какие материалы вы используете для сидений?',
