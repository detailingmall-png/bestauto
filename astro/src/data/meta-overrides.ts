...
export const META_OVERRIDES: Readonly<Record<string, MetaOverride>> = {
  ...
  'ka/blog/benefits-of-vinyl-wraps': {
    title: 'ვინილის ფირის გადაკვრა: უპირატესობები, ვიზუალი,',
    description: 'ვინილის ფირი საშუალებას გაძლევთ შეცვალოთ ავტომობილის ვიზუალი შეღებვის გარეშე. განვიხილავთ მის უპირატესობებს, შეზღუდვებს, მოვლას და განსხვავებას PPF-სგან.',
  },
  ...
  'ka/blog/ceramic-coating-for-car': {
    title: 'ძარის კერამიკული საფარი: უპირატესობები, პროცესი,',
    description: 'რა არის ძარის კერამიკული საფარი, როგორ მუშაობს, რა უპირატესობები აქვს, რამდენ ხანს ძლებს და რით განსხვავდება მექანიკური დაცვისგან.',
  },
  ...
  'ka/blog/ceramic-for-car-glass': {
    title: 'მინებზე კერამიკული საფარი (ანტირაინი): ხილვადობა',
    description: 'კერამიკული საფარი მინებზე აუმჯობესებს ხილვადობას წვიმაში და ამარტივებს მოვლას. ვხსნით პროცესს და რამდენ ხანს ძლებს.',
  },
  ...
  'ka/blog/engine-room-cleaning': {
    title: 'ძრავის განყოფილების წმენდა: როდის არის საჭირო და',
    description: 'როგორ კეთდება კაპოტქვეშა სივრცის წმენდა უსაფრთხოდ, რა სარგებელია და რა რისკებია არასწორი წმენდისას.',
  },
  ...
  'ka/blog/headlight-polishing': {
    title: 'ფარების გაპრიალება: მიზეზები, მეთოდები და რამდენ',
    description: 'ფარების გაპრიალება აღადგენს გამჭვირვალობას და აუმჯობესებს განათებას. ვხსნით მიზეზებს და მოვლას შემდეგ.',
  },
  ...
  'ka/blog/interior-cleaning-for-auto': {
    title: 'სალონის ქიმწმენდა თბილისში: რა შედის, რატომ არის',
    description: 'რას მოიცავს სალონის პროფესიონალური ქიმწმენდა, რამდენი დრო სჭირდება, რა გავლენას ახდენს დაბინძურების დონე და როგორ შევინარჩუნოთ სისუფთავე უფრო დიდხანს.',
  },
  ...
  'ka/blog/polishing-after-repair': {
    title: 'პოლირება კუზოვის შეკეთების შემდეგ: როდის კეთდება',
    description: 'რატომ არის საჭირო პოლირება კუზოვის შეკეთების შემდეგ, როდის შეიძლება მისი გაკეთება და რა შედეგს უნდა ელოდოთ სწორად შესრულებული პროცედურისგან.',
  },
  ...
  'ka/blog/ppf-film-for-cars-protection': {
    title: 'PPF დამცავი ფირი: რას იცავს, სად კეთდება და როგორ',
    description: 'რა არის PPF დამცავი ფირი, რომელ ზონებზე აკრავენ მას ყველაზე ხშირად, როგორ მიმდინარეობს მომზადება და მონტაჟი და როდის ღირს ამ დაცვაში ინვესტიცია.',
  },
  ...
  'ka/blog/replace-or-repair': {
    ...
    description: 'როგორ განისაზღვრება, შეკეთდება თუ არა ნაკენჭარი ან ბზარი: ზომა, მდებარეობა, ხედვის ზონა, უსაფრთხოება და ხარჯი.',
  },
  ...
  'ka/blog/top-11-reasons': {
    title: 'მანქანის მინების დაბურვის 11 მთავარი უპირატესობა',
    description: 'რატომ აკეთებენ მინების დაბურვას: UV დაცვა, სიცხის შემცირება, კონფიდენციალურობა, ინტერიერის დაცვა და მეტი კომფორტი ყოველდღიურ მართვაში.',
  },
  ...
  'ka/blog/why-soundproof-car': {
    title: 'მანქანის ხმის იზოლაცია: რატომ ღირს და რა შედეგს',
    description: 'ხმის იზოლაცია ამცირებს გზის ხმაურს და აუმჯობესებს კომფორტს. ვხსნით, რა ზონებია ყველაზე ეფექტური, რა შედეგს უნდა ელოდოთ და როდის აქვს ამ სერვისს რეალური აზრი.',
  },
  ...
  'ka/blog/why-use-car-diagnostic-test': {
    title: 'კომპიუტერული დიაგნოსტიკა: რატომ არის საჭირო და',
    description: 'როდის უნდა გააკეთოთ კომპიუტერული დიაგნოსტიკა, რა შეცდომებს პოულობს და როგორ გეხმარებათ ძვირი შეკეთებების თავიდან აცილებაში.',
  },
