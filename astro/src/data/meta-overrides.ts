...
export const META_OVERRIDES: Readonly<Record<string, MetaOverride>> = {
  ...
  'ka/': {
    ...
    description: 'პრემიუმ ავტო დეტეილინგი თბილისში - PPF ფირის გადაკვრა, პოლირება, კერამიკა, მინების დაბურვა, ქიმწმენდა და უსაფრთხო რეცხვა. 2 სტუდია თბილისში და უფასო დათვალიერება BESTAUTO-ში.',
  },
  'ru/': {
  ...
  'ka/polishing': {
    ...
    description: 'მანქანის პოლირება თბილისში - ბზინვარების აღდგენა, მიკრონაკაწრების შემცირება, ლაქის ვიზუალის გაუმჯობესება და მომზადება კერამიკული საფარისთვის. პროფესიონალური პოლირება BESTAUTO-ში.',
  },
  'ru/polishing': {
  ...
  // ── Ceramic Coating ─────────────────────────────────────────
  'ka/ceramiccoating': {
    title: 'კერამიკული საფარი მანქანაზე თბილისში - დაცვა და ბზინვარება | BESTAUTO',
    description: 'კერამიკული საფარი მანქანაზე თბილისში - ბზინვარება, ჰიდროფობური ეფექტი, უფრო მარტივი მოვლა და დამატებითი დაცვა. პროფესიონალური მომზადება და კერამიკის გადაკვრა BESTAUTO-ში.',
    ogDescription: 'კერამიკული საფარი მანქანაზე თბილისში - ბზინვარება, ჰიდროფობური ეფექტი, უფრო მარტივი მოვლა და დამატებითი დაცვა. პროფესიონალური მომზადება და კერამიკის გადაკვრა BESTAUTO-ში.',
  },
  'ru/ceramiccoating': {
  ...
  'ka/ppf-shield-wrapping': {
    title: 'მანქანის დამცავი PPF ფირის გადაკვრა თბილისში - პოლიურეთანის დაცვა | BESTAUTO',
    description: 'მანქანის დამცავი PPF ფირის გადაკვრა თბილისში - სრული ან ნაწილობრივი დაფარვა, LLumar, Quantum და LuxArmor ფირები, პოლიურეთანის დამცავი ფენა, self-healing ეფექტი და უფასო დათვალიერება BESTAUTO-ში.',
    ogDescription: 'მანქანის დამცავი PPF ფირის გადაკვრა თბილისში - სრული ან ნაწილობრივი დაფარვა, LLumar, Quantum და LuxArmor ფირები, პოლიურეთანის დამცავი ფენა, self-healing ეფექტი და უფასო დათვალიერება BESTAUTO-ში.',
  },
  ...
  // ── Vinyl Wrapping ──────────────────────────────────────────
  'ka/vinyl-wrapping': {
    title: 'მანქანის ფირით ფერის შეცვლა თბილისში - ფერადი PPF და ვინილი | BESTAUTO',
    description: 'მანქანის ფირით ფერის შეცვლა თბილისში - ფერადი PPF როგორც პრემიუმ გადაწყვეტა და ვინილი როგორც ხელმისაწვდომი ალტერნატივა. მატი, პრიალა, სატინი, ნაწილობრივი ან სრული გადაკვრა BESTAUTO-ში.',
    ogTitle: 'მანქანის ფირით ფერის შეცვლა თბილისში - ფერადი PPF და ვინილი | BESTAUTO',
    ogDescription: 'მანქანის ფირით ფერის შეცვლა თბილისში - ფერადი PPF როგორც პრემიუმ გადაწყვეტა და ვინილი როგორც ხელმისაწვდომი ალტერნატივა. მატი, პრიალა, სატინი, ნაწილობრივი ან სრული გადაკვრა BESTAUTO-ში.',
  },
  'ru/vinyl-wrapping': {
  ...
  'ka/interior-cleaning': {
    title: 'მანქანის სალონის ქიმწმენდა თბილისში - სრული წმენდა 400 ₾-დან | BESTAUTO',
    description: 'მანქანის სალონის ქიმწმენდა თბილისში - სავარძლების, ჭერის, იატაკის, საბარგულის და პლასტმასის ღრმა წმენდა. ლაქების და უსიამოვნო სუნის მოცილება, უსაფრთხო ქიმია და პროფესიონალური გაშრობა.',
  },
  ...
  'ka/windshield-repair': {
    ...
    description: 'საქარე მინის აღდგენა თბილისში - ბზარის და ნაკენჭარის პროფესიონალური შეკეთება, სწრაფი რეაგირება და გამართლებული ალტერნატივა მინის სრულ შეცვლამდე BESTAUTO-ში.',
    ogDescription: 'საქარე მინის აღდგენა თბილისში - ბზარის და ნაკენჭარის პროფესიონალური შეკეთება, სწრაფი რეაგირება და გამართლებული ალტერნატივა მინის სრულ შეცვლამდე BESTAUTO-ში.',
  },
  ...
  'ka/auto-glass-tinting': {
    title: 'მანქანის მინების დაბურვა თბილისში - ფასი, გარანტია | BESTAUTO',
    description: 'მანქანის მინების დაბურვა თბილისში - სტანდარტული, კერამიკული და ატერმალური ფირები, პროფესიონალური ინსტალაცია, სიცხის შემცირება, UV დაცვა და ხარისხიანი ვიზუალი BESTAUTO-ში.',
    ogDescription: 'მანქანის მინების დაბურვა თბილისში - სტანდარტული, კერამიკული და ატერმალური ფირები, პროფესიონალური ინსტალაცია, სიცხის შემცირება, UV დაცვა და ხარისხიანი ვიზუალი BESTAUTO-ში.',
  },
  ...
  'ka/car-soundproofing': {
    title: 'მანქანის ხმის და ვიბრო იზოლაცია თბილისში | BESTAUTO',
    description: 'მანქანის ხმის და ვიბრო იზოლაცია თბილისში - კარების, იატაკის, საბარგულის, თაღების და სხვა ზონების დამუშავება. მეტი კომფორტი, ნაკლები ხმაური და უფრო სასიამოვნო მგზავრობა.',
    ogDescription: 'მანქანის ხმის და ვიბრო იზოლაცია თბილისში - კარების, იატაკის, საბარგულის, თაღების და სხვა ზონების დამუშავება. მეტი კომფორტი, ნაკლები ხმაური და უფრო სასიამოვნო მგზავრობა.',
  },
  ...
  'ka/carwash': {
    ...
    description: 'ავტოსამრეცხაო თბილისში - მანქანის 2-ფაზიანი და 3-ფაზიანი რეცხვა 40 ₾-დან, უსაფრთხო დეტეილინგ პროცესი, pH-ნეიტრალური ქიმია და PPF-ისა და კერამიკისთვის სწორი მოვლა BESTAUTO-ში.',
    ogDescription: 'ავტოსამრეცხაო თბილისში - მანქანის 2-ფაზიანი და 3-ფაზიანი რეცხვა 40 ₾-დან, უსაფრთხო დეტეილინგ პროცესი, pH-ნეიტრალური ქიმია და PPF-ისა და კერამიკისთვის სწორი მოვლა BESTAUTO-ში.',
  },
  'ru/carwash': {
