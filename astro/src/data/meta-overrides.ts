...
export const META_OVERRIDES: Readonly<Record<string, MetaOverride>> = {
  ...
  'ka/polishing': {
    ...
    description: 'მანქანის პოლირება თბილისში: ძარის პოლირება 690 ₾-დან, ფარების 150 ₾-დან, საქარე მინის 250 ₾-დან. ჩაწერა ონლაინ.',
  },
  'ru/polishing': {
  ...
  'ka/windshield-repair': {
    ...
    description: 'საქარე მინის აღდგენა და ნაკენჭრის შეკეთება თბილისში. ლაბავოის, შუშის ბზარების აღდგენა 60 ₾-დან. გამოძახებით.',
  },
  ...
  'ka/locations/guramishvili': {
    ...
    description: 'BESTAUTO გურამიშვილის სტუდია: გურამიშვილის გამზ. 78, გლდანი. PPF, კერამიკა, პოლირება, დაბურვა. ორშ–შაბ 10:00–20:00. უფასო პარკინგი — ჩაეწერეთ ახლავე.',
  },
  ...
  'ka/locations/saburtalo': {
    ...
    description: 'BESTAUTO საბურთალოს სტუდია: ანა პოლიტკოვსკაიას ქ. 51. PPF, კერამიკა, პოლირება, დაბურვა. ორშ–შაბ 10:00–20:00. უფასო პარკინგი — ჩაეწერეთ ახლავე.',
  },
  ...
  'ka/blog/detailing-cost-tbilisi': {
    ...
    description: 'რა ღირს დეტეილინგი თბილისში 2026 წელს: ხელით რეცხვა, ქიმწმენდა, პოლირება, კერამიკა, PPF და დაბურვა. გაიგეთ რა განსაზღვრავს ფასს და რომელი პაკეტია პრაქტიკული თქვენი ავტომობილისთვის.',
  },
  ...
  'ka/blog/efficiency-of-windshield-repair': {
    title: 'საქარე მინის ნაკენჭრის და ბზარის შეკეთება თბილისში — როდის ღირს რემონტი | BESTAUTO',
  ...
  'ka/blog/hints-for-vinyl-wrapped-cars': {
    ...
    description: 'როგორ მოვუაროთ ვინილის ფირით გადაკრულ ავტომობილს: რეცხვის წესები, რა ქიმია არ შეიძლება, რით განსხვავდება მატე და პრიალა ვინილი და როგორ შევინარჩუნოთ ფირის იერი დიდხანს.',
  },
  ...
  'ka/blog/ppf-film-for-cars-protection': {
    title: 'PPF ფირით გადაკვრა: როგორ იცავს ძარას ნაკაწრებისა და ნაკენჭრებისგან',
  ...
  'ka/blog/protection-against-uv-rays-scratches': {
    title: 'ვინილი თუ PPF: რა იცავს უკეთ UV-ის, ნაკაწრებისა და ნაკენჭრებისგან',
    description: 'გაიგეთ რით განსხვავდება ვინილის ფირი და PPF, რომელი სჯობს ვიზუალისთვის და რომელი უკეთ იცავს ძარას UV-ისგან, ნაკაწრებისგან და ნაკენჭრებისგან.',
  },
  ...
  'ka/blog/summer-car-care-georgia': {
    ...
    description: 'როგორ მოვამზადოთ ავტომობილი ზაფხულისთვის საქართველოში: UV, მტვერი, მწერები, ზღვის მარილი, მთის გზები, PPF, კერამიკა, დაბურვა და სალონის მოვლა — პრაქტიკული ჩეკ-ლისტი ერთი სტატიაში.',
  },
  ...
  'ka/blog/windshield-repair-benefits': {
    title: 'საქარე მინის ნაკენჭრის შეკეთება: სარგებელი და როდის ჯობს',
    description: 'რატომ ჯობს ნაკენჭრის დროული შეკეთება: უსაფრთხოება, ხარჯი, დრო და როდის არის შეცვლა აუცილებელი.',
  },
