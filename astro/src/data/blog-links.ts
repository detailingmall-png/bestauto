    ...
    links: [
      {
        ...
        originalPhrase: 'ნაკენჭრის აღდგენა',
        contextQuote: 'მთავარი წესი: ADAS-კამერის ხედვის ზონაში ნაკენჭრის აღდგენა არ კეთდება',
      },
      {
        role: 'bridge',
        target: '/windshield-repair',
        ...
        originalPhrase: 'ნაკენჭრის აღდგენა',
        contextQuote: 'ნაკენჭრის აღდგენა მიდის სტანდარტულად',
      },
    ],
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        anchor: 'ნაკენჭრის აღდგენა',
        originalPhrase: 'ნაკენჭრის აღდგენა',
        contextQuote: 'შესაძლებელია ნაკენჭრის აღდგენა ჩემს ეზოში ან ოფისთან პარკინგზე',
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        target: '/windshield-repair',
        anchor: 'საქარე მინის აღდგენა',
        originalPhrase: 'საქარე მინის ნაკენჭრის აღდგენა ადრეულ ეტაპზე',
        contextQuote: 'საქარე მინის ნაკენჭრის აღდგენა ადრეულ ეტაპზე არა კოსმეტიკური საკითხია, არამედ სტრუქტურული ოპერაცია',
      },
      {
        role: 'pillar',
        target: '/windshield-repair',
      ...
      },
      {
        ...
        target: '/windshield-repair',
        anchor: 'ნაკენჭრის აღდგენა',
        originalPhrase: 'ნაკენჭრის შეკეთების ეტაპები — მიღებიდან გადაცემამდე',
        contextQuote: 'ნაკენჭრის შეკეთების ეტაპები — მიღებიდან გადაცემამდე',
      },
    ],
  },
  // --- General detailing cluster ---
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        target: '/auto-glass-tinting',
        anchor: 'მინების დაბურვა',
        originalPhrase: 'დაბურვა',
        contextQuote: 'დაბურვა ბევრ მძღოლს სწორედ ზაფხულის წინ ახსენდება',
      },
      {
        role: 'pillar',
        target: '/ppf-shield-wrapping',
